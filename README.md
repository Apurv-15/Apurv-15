...
<table>
  <tr>
    <td width="50%">
      ...
      <ul>
        ...
        <li>Features real-time job orchestration, WebSocket progress diagnostics, and headless social media upload automation.</li>
      </ul>
    ...
    <td width="50%">
      ...
      <ul>
        ...
        <li>Crafted smooth 60 FPS visual experiences with <strong>GSAP scrub animations</strong>, Lenis smooth-scrolling, and Framer Motion skeletons.</li>
      </ul>
  ...
  <tr>
    ...
    <td width="50%">
      ...
      <ul>
        <li>High-concurrency autonomous workflow engine solving dynamic CAPTCHAs using <strong>Gemini 1.5 Flash Vision</strong> and multimodal OCR.</li>
        <li>AI cover-letter and interview response synthesis based on candidate resumes and live job postings with 99.4% parsing accuracy.</li>
        <li>Built an observability telemetry console with live queue monitoring, error circuit-breakers, and stealth session orchestration.</li>
      </ul>
...
<table align="center">
  ...
  <tr>
    <td valign="top">
      ...
      • Three.js / WebGL<br>
      • GSAP / Lenis / Framer Motion<br>
      • TypeScript / Tailwind CSS<br>
      • React Native / Expo
    </td>
    <td valign="top">
      • Node.js / Express / FastAPI<br>
      • PostgreSQL / Supabase (RLS)<br>
      • MongoDB / Redis<br>
      • RESTful APIs / WebSockets<br>
